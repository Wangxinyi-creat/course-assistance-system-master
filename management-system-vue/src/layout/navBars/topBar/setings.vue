    ...
    >
      <el-scrollbar class="layout-breadcrumb-seting-bar">
        ...
        <div class="layout-breadcrumb-seting-bar-flex mt15">
          ...
          <div class="layout-breadcrumb-seting-bar-flex-value">
            <el-switch v-model="getThemeConfig.isGrayscale" :width="35"
...
<!--          <el-alert :title="'点击下方按钮，复制布局配置去 `src/store/modules/themeConfig.js` 中修改。'" type="warning"-->
...
<!--          >一键复制配置-->
<!--          </el-button>-->
<!--          <el-button size="small" class="copy-config-btn-reset" type="info" icon="el-icon-refresh-right"-->
...
import {useChangeColor} from '@/utils/style/theme.js';
