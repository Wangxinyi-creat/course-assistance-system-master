    ...
    <el-dialog :title="dialog.title"
      ...
      <el-form ref="experimentDialogFormRef" :model="ruleForm" :rules="rules" size="default" label-width="110px">
        <el-row :gutter="35">
          ...
          <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
            <el-form-item label="正确结果" prop="rightResult">
              <el-input v-model="ruleForm.rightResult" placeholder="请输入正确结果" clearable
                        :disabled="subFlag"
                        type="textarea" :rows="5"></el-input>
            </el-form-item>
          </el-col>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        rightResult: [{required: true, message: '请输入正确结果', trigger: 'blur'}],
